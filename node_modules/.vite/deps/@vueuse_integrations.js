...
// optional-peer-dep:__vite-optional-peer-dep:change-case:@vueuse/integrations
...
// optional-peer-dep:__vite-optional-peer-dep:nprogress:@vueuse/integrations
...
var changeCase = __toESM(require_integrations2(), 1);
...
// optional-peer-dep:__vite-optional-peer-dep:focus-trap:@vueuse/integrations
...
// node_modules/@vueuse/integrations/index.mjs
var import_nprogress = __toESM(require_integrations4(), 1);
var import_qrcode = __toESM(require_integrations5(), 1);
var import_sortablejs = __toESM(require_integrations6(), 1);
...
function useJwt(encodedJwt, options = {}) {
  ...
  const decodeWithFallback = (encodedJwt2, options2) => {
    try {
      return (void 0)(encodedJwt2, options2);
    } catch (err) {
